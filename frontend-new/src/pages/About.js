        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Enterprise-grade security with data encryption and secure access controls.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Optimized performance with modern web technologies and cloud infrastructure.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Built to grow with your institution, from small schools to large universities.</p>
            </div>
