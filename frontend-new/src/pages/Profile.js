                  ...
                  {!editing ? (
                    ...
                    <div className="flex gap-3">
                      <button
                        ...
                        disabled={loading}
                        className="inline-flex items-center px-6 py-2 bg-primary-600 text-white font-medium rounded-lg hover:bg-primary-700 transition-all duration-200 transform hover:scale-105 shadow-lg disabled:opacity-50"
                      >
                        {loading ? (
                          <>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-3">
                      <button
                        ...
                        disabled={imageUploading}
                        className="inline-flex items-center px-4 py-2 bg-white text-primary-600 font-medium rounded-lg hover:bg-gray-50 transition-all duration-200 disabled:opacity-50"
                      >
                        {imageUploading ? (
                          <>
