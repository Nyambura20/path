  ...
  return (
    <PublicLayout>
      <section className="relative overflow-hidden border-b border-neutral-200 bg-white">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(127,29,53,0.09),_transparent_50%)]" />
        <div className="relative mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div className="animate-fade-in">
            <p className="mb-4 inline-flex rounded-full border border-primary-200 bg-primary-50 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-primary-700">
          ...
          <Card className="animate-slide-up border-primary-100">
            <h2 className="text-xl font-semibold text-neutral-900">Platform Snapshot</h2>
            <div className="mt-6 grid grid-cols-2 gap-4">
              <div className="panel p-4 text-center">
                <p className="text-2xl font-bold text-primary-700">1200+</p>
                <p className="mt-1 text-sm text-neutral-500">Active Students</p>
              </div>
              <div className="panel p-4 text-center">
                <p className="text-2xl font-bold text-primary-700">50+</p>
                <p className="mt-1 text-sm text-neutral-500">Available Courses</p>
              </div>
              <div className="panel p-4 text-center">
                <p className="text-2xl font-bold text-primary-700">95%</p>
                <p className="mt-1 text-sm text-neutral-500">Success Rate</p>
              </div>
              <div className="panel p-4 text-center">
                <p className="text-2xl font-bold text-primary-700">24/7</p>
                <p className="mt-1 text-sm text-neutral-500">Insight Access</p>
              </div>
            </div>
          </Card>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-neutral-900">Built for Clarity and Action</h2>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          {features.map((feature) => (
            <Card key={feature.title} className="hover:border-primary-200">
