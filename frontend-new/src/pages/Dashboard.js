          ...
          <div className="bg-gradient-to-r from-secondary-500 to-secondary-600 rounded-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">{dashboardData?.active_enrollments || 0}</p>
              </div>
          ...
          <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">{dashboardData?.avg_grade || 'N/A'}</p>
              </div>
          ...
          <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">{dashboardData?.attendance_rate || 'N/A'}</p>
              </div>
