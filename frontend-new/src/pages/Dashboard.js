        ...
        <div className="mb-8">
          ...
          {enrolledCourses.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {enrolledCourses.slice(0, 6).map((enrollment) => (
                ...
                >
                  ...
                  <h3 className="font-semibold text-gray-900 text-sm mb-1">{enrollment.course_name}</h3>
                  <p className="text-xs text-gray-500">
                    Enrolled: {new Date(enrollment.enrollment_date).toLocaleDateString()}
                  </p>
                  {enrollment.final_grade && (
                    <p className="text-xs text-gray-600 mt-1">Grade: {enrollment.final_grade}</p>
                  )}
                </Link>
              ))}
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
              ...
              <p className="text-sm text-gray-600 mb-4">You haven't enrolled in any courses.</p>
              <Link
                to="/courses"
            ...
            <div className="relative space-y-4 pl-3">
              ...
              {recentPages.length > 0 ? (
                ...
                <div className="rounded-2xl border border-dashed border-gray-200 bg-gradient-to-br from-gray-50 to-white p-8 text-center">
                  ...
                  <p className="mt-1 text-sm text-gray-500">Explore courses, attendance, or performance to start your trail.</p>
                </div>
              )}
            </div>
          </div>
