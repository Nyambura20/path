      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
          <div className="rounded-2xl border border-neutral-200/80 bg-white/95 p-6 shadow-sm backdrop-blur-sm transition hover:-translate-y-0.5 hover:shadow-md">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-primary-700">{totalCourses}</p>
              </div>
          ...
          <div className="rounded-2xl border border-neutral-200/80 bg-white/95 p-6 shadow-sm backdrop-blur-sm transition hover:-translate-y-0.5 hover:shadow-md">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-neutral-800">{totalStudents}</p>
              </div>
          ...
          <div className="rounded-2xl border border-neutral-200/80 bg-white/95 p-6 shadow-sm backdrop-blur-sm transition hover:-translate-y-0.5 hover:shadow-md">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-neutral-500">Pending Grades</p>
                <p className="text-3xl font-bold text-amber-700">{dashboardData?.performance?.summary?.pending_grades || 0}</p>
              </div>
          ...
          <div className="rounded-2xl border border-neutral-200/80 bg-white/95 p-6 shadow-sm backdrop-blur-sm transition hover:-translate-y-0.5 hover:shadow-md">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-neutral-500">New Notifications</p>
                <p className="text-3xl font-bold text-rose-700">{unreadNotifications.length}</p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="card">
              ...
              <div className="relative space-y-4 pl-3">
                <span
                  aria-hidden
                  className="absolute left-3 top-0 hidden h-full w-0.5 bg-gradient-to-b from-primary-200 via-primary-100 to-transparent md:block"
                />
                {recentPages.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-xs font-medium text-gray-500">{page.timeAgo}</span>
                        </div>
                  ...
                  <div className="rounded-2xl border border-dashed border-neutral-200/80 bg-neutral-50 p-8 text-center">
                    ...
                    <p className="mt-4 text-base font-medium text-gray-900">No recent activity yet</p>
                    <p className="mt-1 text-sm text-gray-500">Navigate the platform to start building your teaching timeline.</p>
                  </div>
                )}
              </div>
            </div>
                        ...
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 mb-2">
                            ...
                            <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${
                              notification.type === 'enrollment' ? 'bg-primary-100 text-primary-800' :
