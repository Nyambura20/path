...
function Footer() {
  return (
    <footer className="bg-darkbg-800 dark:bg-darkbg-800 border-t border-darkbg-700 mt-auto text-gray-100">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 max-w-md">
              ...
              manage courses, and achieve academic excellence with our comprehensive 
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="mailto:support@brightpath.edu" className="text-gray-400 hover:text-primary-400 transition-colors">
                  Contact Support
                </a>
              </li>
              <li>
        ...
        {/* Bottom section */}
        <div className="mt-8 pt-8 border-t border-darkbg-700 flex flex-col md:flex-row justify-between items-center">
